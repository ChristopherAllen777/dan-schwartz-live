<?php
/**
 * Harris Media Base Theme functions and definitions
 *
...
function hm_base_theme_scripts() {
	...
	wp_enqueue_style( 'hm-base-theme-style-extra', get_stylesheet_directory_uri().'/style_extra.css', array(), $version );
	wp_enqueue_script( 'tween-js', get_stylesheet_directory_uri() . '/js/Tween.js', array(), $version, true );
	...
	wp_enqueue_script( 'hm-base-theme-ie-js', get_stylesheet_directory_uri() . '/js/html5shiv_respond.js', array(), $version );
